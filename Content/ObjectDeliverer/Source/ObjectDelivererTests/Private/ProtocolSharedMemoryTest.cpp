...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FProtocolSharedMemoryTest, "ObjectDeliverer.ProtocolSharedMemory.BasicTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSharedMemorySizeLimitTest, "ObjectDeliverer.ProtocolSharedMemory.SizeLimitTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FMultipleSharedMemoryTest, "ObjectDeliverer.ProtocolSharedMemory.MultipleInstanceTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSharedMemoryDifferentPacketRuleTest, "ObjectDeliverer.ProtocolSharedMemory.DifferentPacketRuleTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
bool FSharedMemoryDifferentPacketRuleTest::RunTest(const FString &Parameters)
{
	...
	ADD_LATENT_AUTOMATION_COMMAND(FFunctionLatentCommand([this, serverHelper, clientHelper, ObjectDelivererClient, ObjectDelivererServer]()
		...
		if (serverHelper->ReceiveBuffers.Num() > 0)
		{
			...
			OD_LOG(Display, TEXT("Different packet rule test: Received %d packets"),
			       serverHelper->ReceiveBuffers.Num());

			// Log the received data size for diagnostic purposes
			if (serverHelper->ReceiveBuffers.Num() > 0)
			{
				OD_LOG(Display, TEXT("Received data size: %d"),
		...
		else
		{
			...
			OD_LOG(Display, TEXT("Different packet rule test: No packets received"));
		}
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FSharedMemoryBidirectionalTest, "ObjectDeliverer.ProtocolSharedMemory.BidirectionalTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FRapidSharedMemoryTest, "ObjectDeliverer.ProtocolSharedMemory.RapidTransmissionTest", EAutomationTestFlags::EditorContext | EAutomationTestFlags::ClientContext | EAutomationTestFlags::EngineFilter)
...
bool FRapidSharedMemoryTest::RunTest(const FString &Parameters)
{
	...
	ADD_LATENT_AUTOMATION_COMMAND(FFunctionLatentCommand([this, serverHelper, clientHelper, ObjectDelivererClient, ObjectDelivererServer, packetCount]()
		...
		OD_LOG(Display, TEXT("Received %d packets out of %d sent"), serverHelper->ReceiveBuffers.Num(), packetCount);
		...
		for (int32 i = 0; i < verifiedPackets; ++i)
		{
			if (i < serverHelper->ReceiveBuffers.Num())
			{
				...
				if (i >= 5)
				{
					OD_LOG(Display, TEXT("Only verifying first 5 packets in detail to save time"));
					break;
				}
			}
		}
