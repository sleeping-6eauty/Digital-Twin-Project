    ...
    : currentSize(0)
{
    ...
    // Reserve initial capacity but keep logical size at 0
    innerBuffer.SetNum(initialSize);
    // currentSize stays 0 - this is the logical size (how much data is stored)
    // innerBuffer.Num() is the capacity (how much data CAN be stored)
}
