...
UProtocolTcpIpClientTls *UProtocolFactory::CreateProtocolTcpIpClientTls(const FString &IpAddress, int32 Port, bool Retry, bool AutoConnectAfterDisconnect, EObjectDelivererTlsProtocol MinimumProtocol)
{
	auto protocol = NewObject<UProtocolTcpIpClientTls>();
	protocol->InitializeTls(IpAddress, Port, Retry, AutoConnectAfterDisconnect, MinimumProtocol);
	return protocol;
}

UProtocolTcpIpServerTls *UProtocolFactory::CreateProtocolTcpIpServerTls(int32 Port, const FString &CertPath, const FString &KeyPath, EObjectDelivererTlsProtocol MinimumProtocol)
{
	auto protocol = NewObject<UProtocolTcpIpServerTls>();
	protocol->InitializeTls(Port, CertPath, KeyPath, MinimumProtocol);
	return protocol;
}
